...
program
  ...
  .option('-b, --bucket <bucketName>', 'The S3 Bucket Name to configure and use. Defaults to "cloudwatch-alarm-slack-notification-bucket".')
  ...
  .option(
    '-s, --stack <stackName>',
    'The name of the CloudFormation stack to use. Defaults to "CloudWatchAlarmSlackNotifications"')
  .option(
    '-t, --sns <snsTopicName>',
